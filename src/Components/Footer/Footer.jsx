...
import apple_pay from "../assets/apple-pay-svgrepo-com.svg";
    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section company-info">
          ...
          <p>
            Your premier destination for premium fashion. Discover the latest
            trends and timeless classics that define your unique style.
          </p>
          <div className="social-links">
            <a
              href="https://www.instagram.com/_y.sef_/"
            ...
            <a
              href="mailto:yousef.nimreh@gmail.com"
